...
/*
            ...
            String stringHeartRate = "Heart Rate (BPM): " + (String.valueOf(specInfant.heartrate));
            String stringRespRate = "Respiratory Rate : " + (String.valueOf(specInfant.resprate));
            String stringTemp = "Temperature: " + (String.valueOf(specInfant.temp));
            String stringOxSat = "Oxygen Saturation " + (String.valueOf(specInfant.oxsat));
